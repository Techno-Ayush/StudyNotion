...
import MachineLearningThumb from "../assets/Course-image/ml.jpg";
import WebDevThumb from "../assets/Course-image/web-dev.jpg";
import CppThumb from "../assets/Course-image/c++.jpg";
...
export const MOCK_COURSES = [
  {
    ...
    studentsEnrolled: [],
    courseContent: [],
    whatYouWillLearn: "Understand core machine learning concepts, models, training workflow, and practical use cases.",
  ...
  },
  {
    ...
    studentsEnrolled: [],
    courseContent: [],
    whatYouWillLearn: "Build modern full-stack web apps using HTML, CSS, JavaScript, React, Node.js, and APIs.",
    instructions: JSON.stringify([
  ...
  },
  {
    ...
    studentsEnrolled: [],
    courseContent: [],
    whatYouWillLearn: "Learn C++ fundamentals, object-oriented programming, problem solving, and core data structures.",
    instructions: JSON.stringify([
